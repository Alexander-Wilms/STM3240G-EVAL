...
static COMMON volatile uint16_t adc_value;
...
void adc_task (void *)
{
  ...
  portSWITCH_TO_USER_MODE(); // now go protected
...
{
  adc::value = AdcHandle.Instance->DR;
...
static ROM TaskParameters_t task_parameter =
{
    ...
    0,
      ...
      // Base-address Length Parameters
		...
		{ (void *)0x60000000, 0x10000000,	portMPU_REGION_READ_WRITE },
	    { 0, 0, 0 }
      }
};
