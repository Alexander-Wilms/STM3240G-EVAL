 ...
 */
BaseType_t prvRaisePrivilege( void ) __attribute__(( naked ));
...
#if( portUSING_FPU_MPU == 1)
StackType_t *pxPortInitialiseStack( StackType_t *pxTopOfStack, TaskFunction_t pxCode, void *pvParameters, BaseType_t xRunPrivileged, portBASE_TYPE xUseFPU )
#else
...
#endif
{
	...
	*pxTopOfStack = ( StackType_t ) pvParameters;	/* R0 */
	...
	if( xUseFPU)
	{
		pxTopOfStack -= 33;	/* space for all FPU registers and the FPCSR */
		*pxTopOfStack = 0;	/* initial FPCSR */
	}
#endif
	return pxTopOfStack;
}
...
static void prvRestoreContextOfFirstTask( void )
{
	...
	(
		...
		"	ldr r1, [r3]					\n" /* get the TCB */
		"	ldr r1,	[r1, #40]				\n" /* load the FPU flag within the TCB */
		"	tst r1, #0x01					\n" /* Is the task using the FPU context? */
		"	ittt ne							\n" /* If the FPU is used: restore float registers and status */
		"	ldmiane r0!, {r1}				\n"
		"	vmsrne fpscr, r1				\n"
		"	vldmiane r0!, {s0-s31}			\n"
		"									\n"
...
void xPortPendSVHandler( void )
{
  ...
  ENTER_RTOS;
	...
	(
		...
		"	ldr r1,	[r2, #40]					\n" /* load the FPU flag within the TCB */
		"	tst r1, #0x01						\n" /* Is the task using the FPU context? */
		"	ittt ne								\n" /* If the FPU is used: push all VFP registers */
		"	vstmdbne r0!, {s0-s31}				\n"
...
TimerHandle_t MPU_xTimerCreate( const char * const pcTimerName, const TickType_t xTimerPeriodInTicks, const UBaseType_t uxAutoReload, void * const pvTimerID, TimerCallbackFunction_t pxCallbackFunction ) /*lint !e971 Unqualified char types are allowed for strings and single characters only. */
{
  BaseType_t xRunningPrivileged = prvRaisePrivilege ();
			  ...
			  const TickType_t xTicksToWait)
{
  ...
  BaseType_t ret = xTimerGenericCommand (xTimer, xCommandID, xOptionalValue,
